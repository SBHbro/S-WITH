  ...
  methods: {
    ...
    capture(){
     ...
     objectDetection(){
      ...
      axios.post(`http://j3b105.p.ssafy.io/api/ai/objectDetection`,{image : image.src}).then(response=>{
    ...
    textDetection(){
      ...
      axios.post(`http://j3b105.p.ssafy.io/api/ai/textDetection`,{image : image.src}).then(response=>{
        // console.log(response);
