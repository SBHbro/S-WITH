<template>
  <div>
      ...
      <video id="myVideo" playsinline class="video-js vjs-default-skin">
        ...
        <br>
        <v-btn type="button" class="btn btn-info" @click.prevent="startRecording()" v-bind:disabled="isStartRecording" id="btnStart">Start Recording</v-btn>
        <v-btn type="button" class="btn btn-success" @click.prevent="submitVideo()" v-bind:disabled="isSaveDisabled" id="btnSave">{{ submitText }}</v-btn>
