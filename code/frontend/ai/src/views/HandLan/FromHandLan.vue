      ...
      <div class="layout">
        <div class="layout__video">
          ...
          <div class="video__buttons">
            <v-btn class="video__buttons video__buttons--record" id="js-button-record" disabled>Start Recording</v-btn>
            <v-btn class="video__buttons video__buttons--play" id="js-button-play" disabled>Play</v-btn>
            <v-btn class="video__buttons video__buttons--download" id="js-button-download" disabled>Download</v-btn>
          </div>
        </div>
        <div class="layout__video">
