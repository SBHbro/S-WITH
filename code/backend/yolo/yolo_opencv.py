...
def setting():
    ...
    ap.add_argument('-c', '--config', default='.\\yolo\\yolov3.cfg')
    ap.add_argument('-w', '--weights', default='.\\yolo\\yolov3.weights')
    ap.add_argument('-cl', '--classes', default='.\\yolo\\yolov3.txt')
